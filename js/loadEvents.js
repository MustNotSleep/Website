...
function loadPage() {
  ...
  var images = [
        ...
        {path: "/images/2.jpg", caption: "Test caption, 20x40, 2020", alt_text: "Test", display_class: "regular", caption_toggle: "hidden_capt", gal_catergory: "landscape"},
        {path: "/images/3.jpg", caption: "Rembrandt caption", alt_text: "Rembrandt, 1615", display_class: "regular", caption_toggle: "hidden_capt", gal_catergory: "portrait"}*/
      ];
